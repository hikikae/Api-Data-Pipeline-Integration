...
### Cloud Storage 
The data is collected in its original form, without prior processing, in a JSON format and stored together with the static data in the Cloud Storage bucket, i.e. the Data Lake.
<br>
